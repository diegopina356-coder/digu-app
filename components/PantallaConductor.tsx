...
// import MapView, { Marker } from 'react-native-maps'; // <--- DESACTIVADO POR AHORA
...
export default function PantallaConductor({ usuario, volver, socket }) {
      ...
      Alert.alert(
          ...
          [
              ...
              { 
                text: "Sí, Finalizar", 
                onPress: () => {
                  socket.emit('finalizar-viaje', datosParaEnviar);
                }
              }
          ]
      );
  ...
  return (
    <View style={styles.container}>
      ...
      {/* --- MODO SEGURO (SIN MAPA) --- */}
      <View style={styles.mapaPlaceholder}>
        <Ionicons name="map" size={60} color={Colores.gray} />
        <Text style={{color: Colores.gray, marginTop: 10}}>Mapa en Mantenimiento</Text>
        <Text style={{color: Colores.gray, fontSize:10, marginTop: 5}}>Esperando activación de GPS</Text>
      </View>
      {/* ------------------------------ */}
